...
Place skill definitions in this directory.

As the repository grows, each skill can live in its own file or subdirectory with any supporting assets it needs.
...
- `download-itera-diagnostics`: self-contained public skill that downloads read-only Itera organization/project diagnostics for admins.
