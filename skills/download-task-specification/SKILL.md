...
- If the relevant task or planned PR includes UI or UX work, written specs and non-canvas prototype app changes must drive a pixel-perfect implementation of visuals and relevant interactions.
